...
func runPortChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		...
		log.Printf("[ monitorPorts ] function completed (duration: %.2fs)", duration.Seconds())
...
func runProcessChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		duration := time.Since(startTime)
		log.Printf("[ monitorProcesses ] function completed (duration: %.2fs)", duration.Seconds())
...
func runPingChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		duration := time.Since(startTime)
		log.Printf("[ monitorPing ] function completed (duration: %.2fs)", duration.Seconds())
...
func runResourceChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		duration := time.Since(startTime)
		log.Printf("[ monitorResource ] function completed (duration: %.2fs)", duration.Seconds())
...
func runDirectoryChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		duration := time.Since(startTime)
		log.Printf("[ monitorDirectory ] function completed (duration: %.2fs)", duration.Seconds())
...
func runTargetPortChecks(config Config, statuses map[string]*ServerStatus) {
	...
	defer func() {
		duration := time.Since(startTime)
		log.Printf("[ monitorTargetPort ] function completed (duration: %.2fs)", duration.Seconds())
